    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link"
              ><router-link :to="{ name: 'cities' }">Cities</router-link></a
            >
          </li>
          <li class="nav-item">
            <a class="nav-link"
          ...
          <li class="nav-item">
            <a class="nav-link"
              ><router-link :to="{ name: 'news' }">News</router-link></a
            >
          </li>
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown">
              <a class="nav-link"
                ><router-link :to="{ name: 'connect' }">Connect</router-link></a
              >
              <a class="nav-link"
        ...
        <a v-if="user" class="nav-link btn btn-outline" @click="signOut()"
          >Logout</a
        >
