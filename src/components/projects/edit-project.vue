    ...
    <div class="container">
      <div class="jumbotron">
        ...
        <form>
          ...
          <div class="row">
            <div class="col-md-4 mb-3">
              ...
              <p v-for="member in members" :key="member.id">
                <router-link
                  :to="{ name: 'profile', params: { uname: member } }"
                  ><span class="members">{{ member }}</span></router-link
                >
              </p>
              ...
              <div class="input-group">
                ...
                />
                <button
                  :disabled="membernonexistent || memberempty || memberregd"
                  class="btn"
                ...
                <div class="availability">
                  ...
                  <i v-else-if="memberexists" class="material-icons green"
                    >check</i
                  >
                  <i v-else-if="membernonexistent" class="material-icons red"
                    >close</i
                  >
                </div>
              </div>
              <p v-if="memberempty" class="red availability">
                Enter a Username
              </p>
              <p v-else-if="memberregd" class="red availability">
                Member already registered!
              </p>
              <p v-else-if="memberexists" class="green availability">
                Member found!
              </p>
              <p v-else-if="membernonexistent" class="red availability">
                Member not found!
              </p>
            </div>
            <div class="col-md-4 mb-3">
              ...
              <div class="input-group">
                <input
                  ...
                  onpaste="return false"
                  v-model="disability"
                  @input="checkDisability()"
                />
                <button
                  :disabled="disabilityempty || disabilityregd"
                  class="btn"
                  @click.prevent="addDisability()"
                >
                  Add
                </button>
                <div class="availability">
                  <i v-if="disabilityempty" class="material-icons red">close</i>
                  <i v-else-if="disabilityregd" class="material-icons red"
                    >close</i
                  >
                  <i v-else-if="disabilitysuccess" class="material-icons green"
                    >check</i
                  >
                </div>
              </div>
              <p v-if="disabilityempty" class="red availability">
                Enter a Disability
              </p>
              <p v-else-if="disabilityregd" class="red availability">
                Disability already added!
              </p>
              <p v-else-if="disabilitysuccess" class="green availability">
                Add Disability!
              </p>
            </div>
            <div class="col-md-4 mb-3">
              ...
              <div class="input-group">
                <input
                  ...
                  onpaste="return false"
                  v-model="technology"
                  @input="checkTechnology()"
                />
                <button
                  :disabled="technologyempty || technologyregd"
                  class="btn"
                ...
                <div class="availability">
                  ...
                  <i v-else-if="technologyregd" class="material-icons red"
                    >close</i
                  >
                  <i v-else-if="technologysuccess" class="material-icons green"
                    >check</i
                  >
                </div>
              </div>
              <p v-if="technologyempty" class="red availability">
                Enter a Technology
              </p>
              <p v-else-if="technologyregd" class="red availability">
                Technology already added!
              </p>
              <p v-else-if="technologysuccess" class="green availability">
                Add Technology!
              </p>
            </div>
          </div>
            ...
            <div class="col-md-4 mb-3">
              ...
              <div class="custom-control custom-radio">
                <input
                  ...
                  v-model="devstage"
                />
                <label class="custom-control-label" for="prototype"
                  >Prototype</label
                >
              </div>
              <div class="custom-control custom-radio">
          ...
          <div
            class="uploader d-flex flex-column justify-content-center align-items-center rounded"
          >
            <p>{{ imageText }}</p>
            <input
              id="filePhoto"
...
export default {
  ...
  methods: {
    ...
    async checkMember() {
      let membercheck = await db
        .collection("users")
        .where("uname", "==", this.member)
        .get();
    ...
    async checkDisability() {
      let check = this.disabilities.find(
    ...
    async checkTechnology() {
      let check = this.technologies.find(
