  ...
  <main>
    <div class="container">
      <div class="jumbotron">
        ...
        <h5 v-if="completion" class="section-head">
        ...
        <h5 v-if="disabilities.length != 0" class="section-head">
          Disabilities
        </h5>
        <div v-if="disabilities">
          <p
            class="content"
        ...
        <h5 v-if="technologies.length != 0" class="section-head">
          Technologies
        </h5>
