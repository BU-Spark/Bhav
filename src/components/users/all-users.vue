          ...
          <form>
            ...
            <div class="input-group add-on">
              <input
                ...
                id="tagSearch"
                placeholder="Search for User Tags"
            ...
            <p v-else-if="tagfound == false" class="red availability">
              Tag not found!
            </p>
      ...
      >
        <div v-for="user in users" :key="user.id" class="card mb-4 box-shadow">
          <div class="card-header">
            ...
            <span>Username: {{ user.data().uname }}</span>
          </div>
          <div class="card-body">
            ...
            <div class="row justify-content-center align-items-center">
              ...
              <div class="col-auto">
                <router-link
                  :to="{ name: 'chat', params: { uname: user.data().uname } }"
                >
...
export default {
  ...
  methods: {
    async checkTag() {
      let check = await db
        .collection("users")
        .where("tags", "array-contains", this.tagInput)
        .get();
