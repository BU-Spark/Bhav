    ...
    <div class="container">
      <div class="jumbotron">
        ...
        <form>
          <div class="container">
            ...
            <div v-else style="text-align:center">
              <img class="round img" :src="user.profilePic[0]" />
              <span class=" btn text-muted" @click="deleteProfilePic()"
                >Remove</span
              >
            </div>
          </div>
            ...
            <div class="col-md-auto">
              ...
              <div class="input-group">
                ...
                <div class="availability">
                  ...
                  <i v-else-if="skillsuccess" class="material-icons green"
                    >check</i
                  >
                </div>
              </div>
              <p v-if="skillempty" class="red availability">Enter a Skill</p>
              <p v-else-if="skillregd" class="red availability">
                Skill already added!
              </p>
              <p v-else-if="skillsuccess" class="green availability">
                Add Skill!
              </p>
            </div>
          </div>
        ...
        <button
          ...
          type="submit"
          @click="updateProfile() && checkAvailability()"
        >
          Update
        </button>
        <p v-if="fieldempty" class="red availability">
